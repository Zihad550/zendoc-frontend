...
export type AppointmentBookingFormValues = z.infer<
  typeof appointmentBookingValidationSchema
>;
export type AppointmentUpdateFormValues = z.infer<
  typeof appointmentUpdateValidationSchema
>;
export type AppointmentRescheduleFormValues = z.infer<
  typeof appointmentRescheduleValidationSchema
>;
