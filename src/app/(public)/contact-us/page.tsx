  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Header Section */}
          <AnimatedSection variants={animationVariants.floatIn} delay={0.1}>
            <Box sx={{ textAlign: "center", mb: 8 }}>
              ...
              >
                We{"'"}re here to help you with your healthcare needs. Reach out
                to us anytime, and we{"'"}ll respond as quickly as possible.
              </Typography>
            </Box>
          </AnimatedSection>
          ...
          <Grid container spacing={4}>
            ...
            <Grid size={{ xs: 12, lg: 5 }}>
              <AnimatedSection variants={animationVariants.glideIn} delay={0.2}>
                <Box sx={{ mb: 4 }}>
                  <Typography
                    variant="h4"
                    sx={{
                    ...
                    <Grid container spacing={3}>
                      {contactInfo.map((info) => (
                        <Grid size={{ xs: 12, sm: 6, lg: 12 }} key={info.id}>
                          <motion.div variants={animationVariants.cardHover}>
                            <Paper
                              elevation={0}
                              sx={{
                                p: 3,
              ...
              {/* Emergency Contact */}
              <AnimatedSection
                variants={animationVariants.rippleIn}
                delay={0.4}
              >
                <Paper
                  elevation={0}
            ...
            <Grid size={{ xs: 12, lg: 7 }}>
              <AnimatedSection
                variants={animationVariants.slideInDiagonal}
                delay={0.3}
              >
                <Paper
                  elevation={0}
