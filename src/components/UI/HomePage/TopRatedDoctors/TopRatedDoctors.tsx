...
// Dummy data for doctor specialties and ratings
const getDummySpecialties = (id: number) => {
  const specialties = [
    "Cardiology",
    "Neurology",
    "Dermatology",
  ...
  const doctorSpecialties = {
    1: [specialties[0], specialties[4]],
    2: [specialties[1], specialties[7]],
    3: [specialties[2], specialties[5]],
  };
  return (
    doctorSpecialties[id as keyof typeof doctorSpecialties] || [specialties[0]]
  );
};

const getDummyRating = (id: number) => {
  const ratings = { 1: 4.8, 2: 4.6, 3: 4.9 };
  return ratings[id as keyof typeof ratings] || 4.5;
};

const getDummyExperience = (id: number) => {
  const experience = { 1: 12, 2: 8, 3: 15 };
  return experience[id as keyof typeof experience] || 10;
};
            ...
            <Grid size={{ xs: 12, md: 4 }} key={doctor.id}>
              ...
              >
                ...
                >
                  ...
                  >
                    <Rating
                      value={getDummyRating(doctor.id)}
                      readOnly
                      precision={0.1}
                      size="small"
                      icon={
                ...
                <CardContent sx={{ pb: 0, pt: 2.5, px: 2.5, flexGrow: 1 }}>
                  ...
                  >
                    {getDummySpecialties(doctor.id).map((specialty, index) => (
                      <Chip
                        key={index}
                        label={specialty}
                        size="small"
                  ...
                  <Stack spacing={1.5} sx={{ mt: 2 }}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      ...
                      />
                      <Typography variant="body2" color="text.secondary">
                        {getDummyExperience(doctor.id)} years experience
                      </Typography>
                    </Box>
                  </Stack>
                </CardContent>
